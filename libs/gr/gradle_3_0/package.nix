  ...
  mkGradle' =
    ...
    stdenv.mkDerivation {
      ...
      src = fetchFromGitHub {
        ...
        repo = "gradle";
        tag = "v3.0.0";
        hash = "sha256-g/9MMzZP3iY4OznxhxSb0Bfih1kjpC0g89EmU0Be7U8=";
      };
      ...
      patches = [ ./bootstrap-ide-noscala.patch ];
      patchFlags = [ "-p1" ];
      ...
      buildPhase = ''
        ...
        cp -a --dereference ${gradle_3_0_M1}/libexec/gradle/. build/bootstrap/gradle-${version}/
        ...
        buildTimestamp=20160815170000+0000
