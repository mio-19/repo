...
let
  ...
  artifacts = [
    ...
    {
      repo = gradleRepo;
      path = "net/rubygrapefruit/native-platform/0.3-rc-2/native-platform-0.3-rc-2.jar";
      hash = "sha256-Mf35AJh7aGH4LydP4kJJyDGFL/rtZosfM1jjBs46hbY=";
    }
    {
...
stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    ...
    repo = "gradle";
    tag = "v1.6";
    hash = "sha256-smtEqGhrcc067sCEw5J+MMc1NAI3NyYeBs0fjd47bdY=";
  };

  nativeBuildInputs = [ jdk8_headless ];

  patches = [ ./gradle-1.6-direct-bootstrap.patch ];
  ...
  buildPhase = ''
    ...
    cp ${gradle_1_4}/libexec/gradle/lib/*.jar ${gradle_1_4}/libexec/gradle/lib/plugins/*.jar build/lib/
    ...
    buildTimestamp=20130507000000+0000
