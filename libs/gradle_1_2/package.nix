...
let
  ...
  artifacts = [
    ...
    {
      path = "org/ow2/asm/asm-all/4.0/asm-all-4.0.jar";
      hash = "sha256-6s85OVFj14NZ83rBxw5ZA+gwTt9QbtLsEQOn9lGPIZA=";
    }
    {
...
stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    ...
    repo = "gradle";
    tag = "v1.2";
    hash = "sha256-AzKfy7JKVYZBlCcpAaLJ/uaJ0i5sVpIz4oykXtEbG40=";
  };

  nativeBuildInputs = [ jdk8_headless ];

  patches = [ ./gradle-1.2-direct-bootstrap.patch ];
  ...
  buildPhase = ''
    ...
    cp ${gradle_1_1}/libexec/gradle/lib/*.jar ${gradle_1_1}/libexec/gradle/lib/plugins/*.jar build/lib/
    ...
    buildTimestamp=20120912000000+0000
  ...
  meta = {
    description = "Gradle 1.2 runtime and base plugins built directly from source";
