  ...
  mkGradle' =
    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      src = fetchFromGitHub {
        ...
        repo = "gradle";
        tag = "v4.0.0";
        hash = "sha256-A0WzGnxmYFEzL4krk62woltuE6kwYxnErj78wgW/jRk=";
      };
      ...
      gradleFlags = [
        ...
        "-PbootstrapWithGradle4_0_M2=true"
        "-PpromotionCommitId=v4.0.0"
        "-DbootstrapWithGradle3_5_1=true"
        "-DbootstrapWithGradle4_0_M1=true"
        "-DbootstrapWithGradle4_0_M2=true"
