...
let
  version = "0.8-snapshot-20090721-3384fb22";
  artifacts = [
    {
...
stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    owner = "gradle";
    repo = "gradle";
    rev = "3384fb22b89e36a06944f16986a2f149301003f0";
    hash = "sha256-wpTtQq1NRZZ0m8y8ISjhFOYOeHBjzE58djiZM9KvsC4=";
  };

  patches = [ ./gradle-0.8-20090721-bootstrap.patch ];
  ...
  meta = {
    description = "Gradle built from a post-REL-0.7 upstream commit that introduces the code-quality plugin";
