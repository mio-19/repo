...
stdenv.mkDerivation {
  ...
  src = fetchFromGitHub {
    owner = "gradle";
    repo = "gradle";
    rev = "c100a6b7b41ec9bc73f41a2bf015573bbe61d807";
    hash = "sha256-baugdRgqzqBA48+HgSQhhdgy4+rMtWteCq0g0wCWhKE=";
  };

  patches = [ ../gradle_rel_0_7/gradle-rel-0.7-bootstrap.patch ];
  ...
  meta = {
    description = "Gradle built from a post-REL-0.7 upstream commit using the previous bootstrap stage";
