  ...
  mkGradle' =
    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      src = fetchFromGitHub {
        ...
        repo = "gradle";
        tag = "v4.7.0";
        hash = "sha256-kr6MMEJBS1XXzVbn0l3PZFhcwpIgsUQqAYeGRt656F8=";
      };
      ...
      patches = [ ./bootstrap-httpbuilder.patch ];
      patchFlags = [ "-p1" ];
