  ...
  mkGradle' =
    ...
    stdenv.mkDerivation (finalAttrs: {
      ...
      src = fetchFromGitHub {
        ...
        repo = "gradle";
        tag = "v5.2.1";
        hash = "sha256-ukYv5XV2fUDHa01lqSn9E5ORxxIvzVP16K+rAlWpEaM=";
      };
      ...
      preBuild = ''
        ...
        gradleRunnerClasspath="${gradleRunner}/libexec/gradle/lib/plugins/httpclient-4.5.6.jar:${gradleRunner}/libexec/gradle/lib/plugins/httpcore-4.4.10.jar:${gradleRunner}/libexec/gradle/lib/plugins/jsch-0.1.54.jar"
      ...
      postPatch = ''
        ...
        replaceIfPresent buildSrc/subprojects/build-platform/build-platform.gradle.kts \
          '`java-platform`' \
          '`java-library`'
        replaceIfPresent subprojects/distributions-dependencies/distributions-dependencies.gradle.kts \
          '`java-platform`' \
          '`java-library`'
        mkdir -p subprojects/distributions-dependencies/src/main/resources
        cat > subprojects/distributions-dependencies/src/main/resources/distributionsDependencies-classpath.properties <<'EOF'
        runtime=
        projects=
        optional=
        EOF
