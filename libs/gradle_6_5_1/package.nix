...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    repo = "gradle";
    tag = "v6.5.1";
    hash = "sha256-vJu22XHYj1UaffRpyUZp62doLH3PU0viNJCYtuHeVIU=";
  };
  ...
  patches = [
    ...
    ./bootstrap-gradle-6-4-runner.patch
    ./bootstrap-gradle-6-4-runner-build-version.patch
    ./bootstrap-gradle-6-4-runner-buildscan-plugin.patch
