  ...
  ksu-variants = {
    ...
    upstream = {
      src = pkgs.fetchgit {
        ...
        sha256 = "1nx9l6q3kbcb5n2lrpyha3cqwf2kw8rkp213xxyl33wbq8hs40bm";
      };
    ...
    sukisu = {
      src = pkgs.fetchgit {
        ...
        rev = "35659f6b821253a0bb6a3115f083bce5fc56c367";
        sha256 = "1jalcb14vasyqsamgm4wv5c2pkgavf42xpc2hwmd3qiy61157l4p";
      };
