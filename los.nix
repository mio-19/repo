  ...
  ksu-variants = {
    ...
    upstream = {
      src = pkgs.fetchgit {
        ...
        sha256 = "02nh2agrq8pddwl1vg4i2az447a86qw70r2fsn1fpmab8wb7m5hf";
      };
    ...
    sukisu = {
      src = pkgs.fetchgit {
        ...
        rev = "00a5ae168c3598c7d3d85944defceaa333dec5d2";
        sha256 = "1smlva5n8pgcjpp3pl72q9y8kvvw9xzn1bdpf1bbj4qlmnjr8slq";
      };
