  ...
  ksu-variants = {
    ...
    upstream = {
      src = pkgs.fetchgit {
        ...
        sha256 = "0y3mxrmg2fz72qqq2zx0zysnz53b4s6igm3lvzdp7kckd13w9ykp";
      };
    ...
    sukisu = {
      src = pkgs.fetchgit {
        ...
        rev = "9bdbadf5d8ae91d2ceaf727aef492e72f6598a62";
        sha256 = "0nyimljjphyzi51fqwcfb6qbzdj76x757ra473zmw2ghf4wyqrav";
      };
