  ...
  ksu-variants = {
    ...
    upstream = {
      src = pkgs.fetchgit {
        ...
        rev = "097f8324ed666a4812502e0f396d4a959d4e0431";
        sha256 = "053hhaz72xr61iwxy3idrh3dmqp4gyxg2c8hnnag2wc2lcpmwpmb";
      };
    ...
    sukisu = {
      src = pkgs.fetchgit {
        ...
        sha256 = "13r1md5nx6wqswzcsz8arg7iccnslpfi5g8h3qf3sny88hchj269";
      };
