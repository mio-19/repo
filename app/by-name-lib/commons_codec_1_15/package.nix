...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "apache";
    repo = "commons-codec";
    tag = "rel/commons-codec-${finalAttrs.version}";
    hash = "sha256-O2G7KuyqL+wNdF+pePQOnemOpwzJQlZHpioWydXxMx4=";
  };
  ...
  installPhase = ''
    ...
    (
      cd classes
      ${jdk25}/bin/jar cf "$tmp/commons-codec-${finalAttrs.version}.jar" .
    )
