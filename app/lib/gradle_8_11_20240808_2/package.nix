...
gradle-from-source {
  ...
  # org.gradle.kotlin.kotlin-dsl:org.gradle.kotlin.kotlin-dsl.gradle.plugin:5.0.0
  lockFile =
    runCommand "merged-lock"
      ...
      ''
        jq -s '.[0] * .[1]' ${gradle_8_11_20240808_1.unwrapped.passthru.lockFile} ${./more.gradle.lock} > $out
      '';
