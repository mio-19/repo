...
let
  ...
  appVersionName = "1.0.19"; # kept in sync with appVersionName in upstream source code. remember to set upstreamAllowlist's hash to empty to get new hash when bumping version.
  ...
  upstreamAllowlist = fetchurl {
    ...
    url = "https://raw.githubusercontent.com/google-ai-edge/gallery/refs/heads/main/model_allowlists/1_0_18.json"; # 1.0.19 not yet added
