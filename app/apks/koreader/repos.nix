{ fetchgit }: [
  (fetchgit {
    ...
    hash = "sha256-OFz07+Wdhiz/JhQ7AZjsklzM15Z9kJz2KUQpvcVnGsk=";
    leaveDotGit = true;
  ...
  (fetchgit {
    ...
    hash = "sha256-gV4suUmq2ioxCBAH+nU6BuhZf4n1Uw+82JfmJAmFyUw=";
    leaveDotGit = true;
    fetchSubmodules = true;
  })
  (fetchgit {
  ...
  (fetchgit {
    ...
    hash = "sha256-5z8Se8DTQ/tZa1OEzzcxQUVpAFIVzqV2hmNYVtAOoNo=";
    leaveDotGit = true;
    fetchSubmodules = true;
  })
  (fetchgit {
  ...
  (fetchgit {
    ...
    hash = "sha256-cR240fEr6Oodl+acT+I/d1YjwKzgX/9P949jbDAOgFM=";
    leaveDotGit = true;
    fetchSubmodules = true;
  })
  (fetchgit {
