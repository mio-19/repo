...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-l8ESDihx2+9KJa0DD+9k/3CJUxfp2lHVZUYMiFRO0JQ=";
  };
  ...
  mitmCache = gradle.fetchDeps {
    ...
    data = ./instagram-morphe-patches-library-m2_1_1_0_deps.json;
    silent = false;
    useBwrap = false;
  };
  ...
  prePatch = ''
    ...
    substituteInPlace "settings.gradle.kts" \
      ...
      'url = uri("file://${morphe-patches-library-m2_1_6_2}")' \
      --replace-fail \
