{
  ...
  morphe-library-m2,
  morphe-patches-library-m2_1_3_4_dev_1,
  apktool-src,
  multidexlib2-src,
  morphe-patcher-src,
}:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-Nw7Ly2cEVjhlizjClg2Y1uiKc7CZ2P76M0Oma3QR2z8=";
  };
  ...
  env = {
    ...
    MORPHE_PATCHES_LIBRARY_M2 = "${morphe-patches-library-m2_1_3_4_dev_1}";
  };
