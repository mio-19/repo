{
  ...
  morphe-library-m2,
  morphe-patches-library-m2_1_4_0_dev_5,
  apktool-src,
  multidexlib2-src,
  morphe-patcher-src,
}:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-y6/YtJ0RNoOWEm9t9W8M/U2lR9kd/uBdWY8AsWay7BQ=";
  };
  ...
  env = {
    ...
    MORPHE_PATCHES_LIBRARY_M2 = "${morphe-patches-library-m2_1_4_0_dev_5}";
  };
