{
  ...
  morphe-library-m2,
  morphe-patches-library-m2_1_4_0_dev_4,
  apktool-src,
  multidexlib2-src,
  morphe-patcher-src,
}:
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-nKPH39bBF35Bx0izKpY3Gm29ztnWhURl7wzC2H3rhX8=";
  };
  ...
  env = {
    ...
    MORPHE_PATCHES_LIBRARY_M2 = "${morphe-patches-library-m2_1_4_0_dev_4}";
  };
