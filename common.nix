  ...
  ksu-variants = {
    next = {
      src = pkgs.fetchgit {
        ...
        rev = "f40fe9b9e1e6ff09686dcc68af8a4cee52d48bf2";
        sha256 = "0rr2sykzkla6wzqm9f0mc09b9xzxydmzg83pqyqwq5svfam17bag";
      };
    ...
    sukisu = {
      src = pkgs.fetchgit {
        ...
        sha256 = "1sb1sblw14vs6mqsp22fg9srynhagbbwc4rzc8ap7a5ggz2kzpkh";
      };
