  ...
  ksu-variants = {
    ...
    upstream = {
      src = pkgs.fetchgit {
        ...
        sha256 = "1r774jx44bimvr3fyrppzb1qx7jjqad23mn9f2s1llpz5daqpmxz";
      };
    ...
    sukisu = {
      src = pkgs.fetchgit {
        ...
        rev = "0b80137f1794680d305631655e3ee7d21db11c09";
        sha256 = "1f0wmy1m19h76b9153d5fkwghi12ai9wy1lphldlslvagyz0a4m2";
      };
