...
adjusted patch with  Stock-based variant: pixel8pro-stock.patch with kernel crash fix: pixel8pro-stock-fix.patch - pixel8pro-14.0.0-sultan-pwm.patch and pixel8pro-stock.patch don't have actual code difference
